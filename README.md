# Inside the Black Box: A Deep Dive into Large Language Models

Welcome to the GitHub repository for **Inside the Black Box: A Deep Dive into Large Language Models**.

This repository contains course materials, announcements, readings, and other resources for the class.
...
- Programming skills are not necessary but are always welcome

---

## How to Use This Repository

You can use this repository throughout the semester to access:
...
- [`lectures/`](lectures/) – notes, and class materials
- [`presentations/`](presentations/) – list of presentations for each week and paper list
- [`resources/`](resources/) – extra resources, tools, and helpful links
